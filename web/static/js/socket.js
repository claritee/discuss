...
socket.connect(); //connects to backend server
...
const createSocket = (topicId) => {
	...
	// Note: leaving this here as a way to test the socket
...
window.createSocket = createSocket; //create socket and join the given channel
